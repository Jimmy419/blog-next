const JTool = async () => {
  const codeSnippets = [
    `import {accAdd} from './calculator'; console.log(accAdd(0.1, 0.2));
            // 输出: 0.3`,
    `import { accMinus } from './calculator';
    console.log(accMinus(0.3, 0.1)); // 输出: 0.2`,
    `import {accMultiply} from './calculator';
            console.log(accMultiply(0.1, 0.2)); // 输出: 0.02`,
    `import {accDivide} from './calculator'; console.log(accDivide(0.3,
            0.1)); // 输出: 3`,
  ];
  return (
    <div>
